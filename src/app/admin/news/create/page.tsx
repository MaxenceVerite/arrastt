  ...
  return (
    <div className="max-w-4xl mx-auto pb-12">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-black text-primary-dark uppercase">Nouvelle actualité</h1>
        <Link 
          href="/admin/news"
      ...
      <form className="bg-white p-8 border-4 border-primary-dark shadow-[8px_8px_0px_0px_rgba(10,45,108,1)] flex flex-col gap-6">
        ...
        <div>
          ...
          <input type="text" className="w-full p-4 border-2 border-zinc-300 focus:border-primary focus:outline-none transition-colors font-medium" placeholder="Ex: Victoire de l'équipe 1" />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-bold text-primary-dark uppercase mb-2">Catégorie</label>
            <select className="w-full p-4 border-2 border-zinc-300 focus:border-primary focus:outline-none transition-colors font-medium appearance-none bg-white">
        ...
        <div>
          ...
          <textarea rows={10} className="w-full p-4 border-2 border-zinc-300 focus:border-primary focus:outline-none transition-colors font-medium resize-y" placeholder="Rédigez votre article ici..."></textarea>
        </div>
